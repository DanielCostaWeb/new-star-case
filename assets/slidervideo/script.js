...
(function() {
    ...
    function getYTPreviewUrl(videoId, quality) {
        return 'https://web.archive.org/web/20250122205831/https://img.youtube.com/vi/' + videoId + '/' +
            (quality || '') + 'default.jpg';
    }

    function getVimeoPreviewUrl(vimeoId, callback) {
        var request = new XMLHttpRequest();
        request.open('GET', 'https://web.archive.org/web/20250122205831/https://vimeo.com/api/v2/video/' + vimeoId + '.json', true);
...
/*
     ...
     INTERNET ARCHIVE ON 05:17:32 Oct 11, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 6.021
  LoadShardBlock: 154.53 (3)
  PetaboxLoader3.datanode: 148.332 (5)
  PetaboxLoader3.resolve: 1270.601 (3)
  load_resource: 1290.096 (2)
*/